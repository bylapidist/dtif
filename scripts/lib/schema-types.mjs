...
import * as dtsGeneratorModule from 'dtsgenerator';
const dtsgenerator =
  dtsGeneratorModule.default?.default ?? dtsGeneratorModule.default ?? dtsGeneratorModule;
const { parseSchema } = dtsGeneratorModule;
