...
import type { ResolvedTokenTransformEntry, ResolvedTokenTransformEvaluation } from '../../plugins/index.js';
...
export const EMPTY_TRANSFORM_EVALUATIONS: readonly ResolvedTokenTransformEvaluation[] = Object.freeze([]);
